...
tf.app.flags.DEFINE_string('pretrained_model_path', '../train/MNIST/train/MNIST_TRAIN.pkl',
                           """Path to the pretrained model.""")
tf.app.flags.DEFINE_string('pretrained_info_path', '../train/MNIST/train/MNIST_TRAIN_INFO.pkl',
                           """Path to the pretrained model.""")
