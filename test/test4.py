...
# pre-define model
assert tf.gfile.Exists("../train/MNIST/train/MNIST_TRAIN.pkl"), 'Cannot find pretrained model at the given path:' '  {}'.format("../train/MNIST/train/MNIST_TRAIN.pkl")
caffemodel_weight = joblib.load("../train/MNIST/train/MNIST_TRAIN.pkl")

assert tf.gfile.Exists("../train/MNIST/train/MNIST_TRAIN_INFO.pkl"), 'Cannot find pretrained model at the given path:' '  {}'.format("../train/MNIST/train/MNIST_TRAIN_INFO.pkl")
caffemodel_weight_info = joblib.load("../train/MNIST/train/MNIST_TRAIN_INFO.pkl")
